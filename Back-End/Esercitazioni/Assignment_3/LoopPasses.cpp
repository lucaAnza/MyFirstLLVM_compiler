 ...
 *
 */
void move_to_preheader(Loop *L, std::set<Instruction*> &loop_invariant_instructions) {
 ...
 *
 */
bool instruction_dominates_all_uses(Instruction *I, DominatorTree &DT, Loop &L) {
  for (User *U : I->users()) {
