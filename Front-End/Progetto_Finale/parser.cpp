...
#line 78 "parser.yy"
                        { yylhs.value.as < RootAST* > () = new SeqAST(yystack_[2].value.as < BindingAST* > (),yystack_[0].value.as < RootAST* > ()); }
#line 759 "parser.cpp"
    break;
...
#undef YYCASE_
  ...
  parser::yyrline_[] =
  {
       0,    73,    73,    76,    77,    78,    81,    84,    85,    88,
      89,    90,    93,    96,    99,   102,   104,   111,   112,   113,
     114,   115,   116,   117,   120,   121,   124,   126,   129,   133
  };
